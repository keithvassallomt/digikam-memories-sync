...
export function create({ go, refresh }) {
    ...
    return h('div', {},
        ...
        ? card(
            h('div', { class: 'row-start' },
              ...
              h('div', {},
                ...
                h('div', { class: 'muted' },
                  'DigiMem copies the database before the first local change.'))))
        : card(
      ...
      needsClose
        ? card(
            ...
            h('p', { class: 'muted' },
              'digiKam must be closed while DigiMem updates its face database.'),
            h('div', { class: 'row' },
  ...
  function applyProgress(run) {
    ...
    return card(
      ...
      h('p', { class: 'note' },
        'You can close this window. Applying continues while DigiMem is running.'));
  }
  ...
  async function discard() {
    ...
    const confirmed = window.confirm(
      `Discard ${what}?\n\n`
      + 'Nothing has been changed in either library. DigiMem will have to '
